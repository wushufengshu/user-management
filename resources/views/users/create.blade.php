                        ...
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            ...
                            <div class="col-span-12 sm:col-span-6 lg:col-span-2">
                                ...
                                <div class="gap-6 flex flex-col-3 pt -3">
                                    ...
                                    <input id="mr" value="mr" name="prefixname" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                    <label for="mr" class="ml-3 block text-sm font-medium text-gray-700">
                                        Mr.
                                    </label>
                                    </div>
                                    <div class="flex items-center">
                                    <input id="mrs" value="mrs" name="prefixname" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                    <label for="mrs" class="ml-3 block text-sm font-medium text-gray-700">
                                        Mrs.
                                    </label>
                                    </div>
                                    <div class="flex items-center">
                                    <input id="ms" value="ms" name="prefixname" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                            ...
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="col-span-12 sm:col-span-12 lg:col-span-4">
                                    ...
                                    <input type="text" name="middlename" id="middlename" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                            ...
                            <div class="col-span-3 sm:col-span-6 lg:col-span-1">
                                    ...
                                    <input type="text" name="suffix" id="suffix" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-4 lg:col-span-2">
                                ...
                                <input type="email" name="email" id="email" required autocomplete="email" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-4 lg:col-span-2">
                                ...
                                <input type="password" name="password" id="password" required autocomplete="new-password" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            </div>
